        ...
        <div v-if=" user">
            ...
            <div class="group flex relative dropdown text-start">
                ...
                <button
                    ...
                    class=" btn z-10 flex items-center p-2 text-sm text-gray-600 bg-white border-s   border-primary-200   focus:border-blue-500 focus:ring-opacity-40 dark:focus:ring-opacity-40 focus:ring-blue-300 dark:focus:ring-blue-400 focus:ring dark:text-white dark:bg-gray-800 focus:outline-none">
                ...
                <ul v-if="  chevronShow" @mouseover="chevronRotate=true" @mouseleave="chevronRotate=false"
                    class="flex flex-col z-[1044]   bg-white  border shadow-xl rounded-lg transform scale-0 group-hover:scale-100  absolute end-0 top-10
