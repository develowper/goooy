<template>
  <nav class="fixed w-full z-[1043] top-0 ">
    <div class="max-w-7xl  mx-auto   px-2 lg:px-4">
      <div class="flex justify-between">
        <div class="flex items-center space-x-4">
          <!-- Website Logo -->
          <div>
            <Link :href="route('dz.index')" class="flex items-center py-4 px-2">
        ...
        <div
          ...
          <div class="flex items-center">
            ...
            <!--              {{ __('contact_us') }}-->
            <!--            </button>-->
            <Link :href="route('dz.page.contact-us')" class="nav-item " :class="navClasses('dz.page.contact-us')">
              {{ __('contact_us') }}
            </Link>
        ...
        <div class="md:hidden flex items-center   ">
          <button class="h-10 w-10  p-1  border-2 rounded-lg  mobile-menu-button ">
    ...
    <div
      ...
      <Link :href="route('dz.index')" class="px-4   nav-item text-center" :class="navClasses('dz.index')">
        {{ __('home') }}
      </Link>
      ...
      <!--        {{ __('contact_us') }}-->
      <!--      </button>-->
      <Link :href="route('dz.page.contact-us')" class="nav-item text-center" :class="navClasses('dz.page.contact-us')">
        {{ __('contact_us') }}
      </Link>
    </div>
...
import CartButton from "@/Components/DZ/CartButton.vue";
import UserButton from "@/Components/DZ/UserButton.vue";
...
export default {
  ...
  methods: {
    navClasses(item) {
      let base = "py-4 rounded-lg px-2 lg:px-2    font-semibold  transition text-white   hover:bg-primary-400 hover:text-white  duration-300 ";
    ...
    setScrollListener() {
      ...
      var buttons = [...document.querySelectorAll(".btn"), document.querySelector("button.mobile-menu-button")];
