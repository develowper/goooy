      ...
      <div class="   ">
        ...
        <div
          ...
          <div class="flex">
            ...
            <h5 class="  font-semibold">{{ `${__('preorders_list')} ` }}</h5>

          </div>
          <div v-if="false">
            <Link v-if="hasAccess('create_preorder')" :href="route('admin.panel.order.user.create')"
                  ...
                  <tr v-for="(d,idx) in data"
                    ...
                    <td class="px-2 py-4    " data-te-dropdown-ref>
                      ...
                      <ul :ref="`statusMenu${d.id}`" data-te-dropdown-menu-ref
                        ...
                        <li v-for="(s,ix) in  $page.props.order_statuses" role="menuitem"
                            @click="showDialog('danger',   __('accept_change_status_order'),__('accept'),edit,{'idx':idx,'id':d.id,'cmnd':'status','status':s.name}) "
                    ...
                    <td class="px-2 py-4">
                      <!-- Actions Group -->
                      <div
                          class=" flex justify-end rounded-md shadow-sm transition duration-150 ease-in-out    focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0   active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]"
                          role="group">
                        <Link
                            type="button" :href="route('admin.panel.preorder.edit',d.id)"
                        ...
                        <Link
                            type="button" :href="route('admin.panel.preorder.factor',d.id)"
                        ...
                        <button
                            type="button"
                            @click="showDialog('danger',  __('accept_delete_order'),__('accept'),edit,{'idx':idx,'id':d.id,'cmnd':'delete' })"
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      window.axios.get(route('admin.panel.preorder.search'), {
        params: this.params
      }, {})
          .then((response) => {
    ...
    edit(params) {
      this.isLoading(true);
      this.errors = {};
      window.axios.patch(route('admin.panel.preorder.update'), params,
          {})
          .then((response) => {
