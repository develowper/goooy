  ...
  <Panel>
    ...
    <template v-slot:content>
      ...
      <div
        ...
        <div>
          <Link :href="route('admin.panel.article.create')"
        ...
        <div class="flex-col   bg-white  overflow-x-auto shadow-lg  rounded-lg">
          ...
          <table class="w-full text-sm text-left text-gray-500">
            ...
            <tr v-for="(d,idx) in data"
              ...
              <td
                  class="flex  items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                <Image class="w-10 h-10 cursor-pointer rounded-full" :src="`${route('storage.articles')}/${d.id}.jpg`"
                       :data-lity="`${route('storage.articles')}/${d.id}.jpg`"
                       :alt="cropText(d.title,5)"/>
                <Link class="px-3 hover:text-gray-500" :href="route('admin.panel.article.edit',d.id)">
              ...
              <td class="px-2 py-4">
                ...
                <div
                    ...
                    role="group">
                  <Link
                      type="button" :href="route('admin.panel.article.edit',d.id)"
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.loading = true;
      this.data = [];
      window.axios.get(route('admin.panel.article.search'), {
        params: this.params
      }, {})
          .then((response) => {
    ...
    edit(params) {
      this.isLoading(true);
      window.axios.patch(route('admin.panel.article.update'), params,
          {})
          .then((response) => {
