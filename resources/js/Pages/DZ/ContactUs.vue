<template>
  <DZScaffold>
    <template v-slot:header>
      <title>{{__('contact_us')}}</title>

    </template>
    <div>
      <div class="bg-primary-500 h-16"></div>
      <section class="card max-w-lg mx-auto m-2 shadow-md rounded-lg bg-white p-2 flex flex-col items-center">
