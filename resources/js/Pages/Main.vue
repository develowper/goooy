    ...
    <Scaffold>
        ...
        <div v-if="true">
            <div
                ...
                <div class="pt-24 md:pt-32 xl:py-32   z-10 z-[1043]   mx-auto    ">
                            ...
                            <div v-if="false" class="w-full mx-auto mt-2  ">
                                <div class="relative  px-6 mx-auto  ">
                                    <div
                                        ...
                                        <span
                                            class="absolute border-gray-300  border-s top-0 bottom-0 my-2 ms-6"></span>
                                    </div>
                        ...
                        <div class="m-4 mt-8 gap-4 grid md:grid-cols-2 lg:grid-cols-4 bounce-top-icons">
                            ...
                            <div v-for="(item,idx) in section1"
                                ...
                                <component v-bind:is="item.icon"
                                           class="w-12 h-12 lg:w-24 lg:h-24 text-primary-500"></component>
                                ...
                                <!--wave-->
                                <svg class="absolute z-[-1] opacity-70 bottom-0 w-full start-0 wave-top"
                                    ...
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g transform="translate(-1.000000, -14.000000)" fill-rule="nonzero">
                                            ...
                                            <g transform="translate(0.000000, 50.000000)" class="fill-primary-500"
                                               fill=""
                                               fill-rule="nonzero">
                                                <path
...
export default {
    data() {
        return {
            ...
            loading: false,
            heroImage,
            heroText: this.$page.props.hero_text,
